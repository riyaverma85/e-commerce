  ...
  <div className="container">
    ...
    <div className="testimonial-cards">
      <div className="testimonial-card">
        <p>"The fruits and vegetables are always fresh and delicious. Highly recommend OrganicMart!"</p>
        <h4>- Riya Sharma</h4>
      </div>
      <div className="testimonial-card">
        <p>"Amazing service and quality. I love that everything is organic and eco-friendly."</p>
        <h4>- Amit Kumar</h4>
      </div>
      <div className="testimonial-card">
        <p>"Best organic products in town! Healthy, fresh, and delivered to my doorstep."</p>
        <h4>- Sneha Patel</h4>
      </div>
    </div>
  </div>
...
{/* ==============================================Eleventh Section========================================== */}
{/* Seasonal Offers / Best Sellers */}
<section className="best-sellers">
  <div className="container">
    <h2>Seasonal Offers & Best Sellers 🍎</h2>
    <div className="best-seller-grid">
      <div className="best-seller-card">
        <img src={product1} alt="Fresh Tomato" />
        <h4>Fresh Tomato</h4>
        <p>$40.00 <span className="old-price">$50.00</span></p>
      </div>
      <div className="best-seller-card">
        <img src={product2} alt="Fresh Pineapple" />
        <h4>Fresh Pineapple</h4>
        <p>$100.00 <span className="old-price">$120.00</span></p>
      </div>
      <div className="best-seller-card">
        <img src={product3} alt="Green Chili" />
        <h4>Green Chili</h4>
        <p>$30.00 <span className="old-price">$60.00</span></p>
      </div>
    </div>
  </div>
</section>
...
<section className="blog-tips">
  <div className="container">
    <h2>Healthy Eating Tips & Recipes 🌿</h2>
    <div className="blog-cards">
      <div className="blog-card">
        <h4>5 Ways to Eat Organic Daily</h4>
        <p>Simple tips to incorporate fresh organic produce into your everyday meals.</p>
      </div>
      <div className="blog-card">
        <h4>Top 10 Organic Recipes</h4>
        <p>Delicious, easy-to-make recipes using the freshest organic ingredients.</p>
      </div>
      <div className="blog-card">
        <h4>Benefits of Going Green</h4>
        <p>Learn how organic living improves health and sustainability.</p>
      </div>
    </div>
  </div>
</section>
...
<section className="newsletter">
  <div className="container">
    ...
    <p>Get the latest news, recipes, and offers delivered to your inbox.</p>
...
<section className="certifications">
  <div className="container">
    ...
    <div className="cert-grid">
      ...
      <div className="cert-card">
        <img src="cert4.png" alt="Certification 4" />
      </div>
    </div>
  </div>
</section>
